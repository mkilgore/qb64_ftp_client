...
FOR x = 1 TO next_line
  source(x) = replace_with_case$(source(x), "_OFFSET", "_OFFSET")
...
DO
  ...
  IF process_line and not cmd_flag and not include_flag then 
    
      
    
      if left$(uls$, 4) = "SUB " then
        ls$ = replace_with_case$(ls$, "_OFFSET", "_OFFSET")
...
DECLARE CUSTOMTYPE LIBRARY "parse_func_OUTPUT"
  ...
  FUNCTION ADD_SOURCE_LINES_ptr%& ()
  FUNCTION ADD_FUNC_VAR_ptr%& ()
  FUNCTION CLEAR_FUNC_VARS_ptr%& ()
  FUNCTION REG_SUB_ptr%& ()
  FUNCTION REG_ARG_ptr%& ()
  FUNCTION FUNC_REG_ARG_ptr%& ()
  FUNCTION REG_FUNC_ptr%& ()
  FUNCTION ADD_POINTER_DEFS_ptr%& ()
  ...
  FUNCTION FIND_DEFINE_ptr%& ()
  FUNCTION STRIP_LINE_ptr%& ()
  FUNCTION STRIP_QUOTE_ptr%& ()
  FUNCTION GET_DIR_ptr%& ()
  FUNCTION GET_FILE_ptr%& ()
  FUNCTION MAKE_DEREF_INTO_FUNC_ptr%& ()
  FUNCTION MAKE_DEREF_INTO_SUB_ptr%& ()
  FUNCTION REPLACE_ptr%& ()
  FUNCTION FIX_SPACE_ptr%& ()
  FUNCTION PARSE_ARGS_ptr%& ()
  FUNCTION STRIP_COMMENT_ptr%& ()
  FUNCTION REMOVE_SUFFIX_ptr%& ()
  FUNCTION GET_TYPE_NAME_ptr%& ()
  FUNCTION GET_TYPE_FROM_SUFFIX_ptr%& ()
  FUNCTION GET_SUFFIX_FROM_TYPE_ptr%& ()
  FUNCTION GET_C_TYPE_PTR_FROM_QB_TYPE_ptr%& ()
  FUNCTION GET_C_TYPE_FROM_QB_TYPE_ptr%& ()
  FUNCTION QQ_ptr%& ()
  FUNCTION REPLACE_WITH_CASE_ptr%& ()
  ...
  SUB c_STRING_LONG( BYVAL va AS _OFFSET, A AS STRING, B AS LONG)
  SUB c_STRING_STRING( BYVAL va AS _OFFSET, A AS STRING, B AS STRING)
  SUB c_STRING( BYVAL va AS _OFFSET, A AS STRING)
  SUB c_STRING_LONG_STRING( BYVAL va AS _OFFSET, A AS STRING, B AS LONG, C AS STRING)
  SUB c_SINGLE_STRING( BYVAL va AS _OFFSET, A AS SINGLE, B AS STRING)
  SUB c_SINGLE( BYVAL va AS _OFFSET, A AS SINGLE)
  SUB c_STRING_STRING_STRING( BYVAL va AS _OFFSET, A AS STRING, B AS STRING, C AS STRING)
  ...
  FUNCTION fc_SINGLE_STRING!( BYVAL va AS _OFFSET, A AS STRING)
  FUNCTION fc_STRING_STRING$( BYVAL va AS _OFFSET, A AS STRING)
  FUNCTION fc_STRING_STRING_SINGLE_SINGLE$( BYVAL va AS _OFFSET, A AS STRING, B AS SINGLE, C AS SINGLE)
  FUNCTION fc_STRING_STRING_STRING_SINGLE$( BYVAL va AS _OFFSET, A AS STRING, B AS STRING, C AS SINGLE)
