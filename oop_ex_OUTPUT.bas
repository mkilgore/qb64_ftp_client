...
CONST GUI_ELEMENT_FRAME_FLAG_DIALOG = 2
CONST GUI_WINDOW = 3
...
$CHECKING:OFF
CALL__OFFSET  _MEMGET(GUI__QB64__EMPTY_MEM, WIN + _OFFSET(GUI_ELEMENT.DRW, TYPE), _OFFSET) , WIN
$CHECKING:ON
...
$CHECKING:OFF
_MEMPUT GUI__QB64__EMPTY_MEM, THIS+ _OFFSET(GUI_OBJECT.REF_COUNT, TYPE),  0 AS LONG
$CHECKING:ON
...
$CHECKING:OFF
_MEMPUT GUI__QB64__EMPTY_MEM, THIS+ _OFFSET(GUI_OBJECT.REF_COUNT, TYPE),  _MEMGET(GUI__QB64__EMPTY_MEM, THIS + _OFFSET(GUI_OBJECT.REF_COUNT, TYPE), LONG)  + 1 AS LONG
$CHECKING:ON
...
$CHECKING:ON
$CHECKING:OFF
IF _MEMGET(GUI__QB64__EMPTY_MEM, THIS + _OFFSET(GUI_OBJECT.REF_COUNT, TYPE), LONG)  = 0 THEN
$CHECKING:ON
$CHECKING:OFF
CALL__OFFSET  _MEMGET(GUI__QB64__EMPTY_MEM, THIS + _OFFSET(GUI_OBJECT.DELETE, TYPE), _OFFSET) , THIS
$CHECKING:ON
  end if

  END SUB
  
  SUB GUI_Object_set_delete_proc (this as _OFFSET, pro AS _OFFSET)
$CHECKING:OFF
_MEMPUT GUI__QB64__EMPTY_MEM, THIS+ _OFFSET(GUI_OBJECT.DELETE, TYPE),  PRO
$CHECKING:ON
...
$CHECKING:OFF
IF _MEMGET(GUI__QB64__EMPTY_MEM, THIS + _OFFSET(GUI_ELEMENT.IMG, TYPE), LONG)  <> 0 THEN
$CHECKING:ON
$CHECKING:OFF
...
$CHECKING:OFF
_MEMPUT GUI__QB64__EMPTY_MEM, THIS+ _OFFSET(GUI_ELEMENT.PARENT, TYPE),  GUI_OBJECT_GET_REF%&(PARENT) AS _OFFSET
$CHECKING:ON
...
$CHECKING:ON
$CHECKING:OFF
GUI_OBJECT_RELEASE_REF _MEMGET(GUI__QB64__EMPTY_MEM, THIS + _OFFSET(GUI_ELEMENT.PARENT, TYPE), _OFFSET) 
$CHECKING:ON
$CHECKING:OFF
...
$CHECKING:OFF
_MEMPUT GUI__QB64__EMPTY_MEM, THIS+ _OFFSET(GUI_ELEMENT_CONTAINER.ELEMENT, TYPE),  GUI_OBJECT_GET_REF%&(OBJ) AS _OFFSET
$CHECKING:ON
$CHECKING:OFF
...
$CHECKING:OFF
GUI_OBJECT_RELEASE_REF _MEMGET(GUI__QB64__EMPTY_MEM, THIS + _OFFSET(GUI_ELEMENT_CONTAINER.ELEMENT, TYPE), _OFFSET) 
$CHECKING:ON
...
GUI_Object_set_delete_proc this, GUI_ELEMENT_BUTTON_DELETE_ptr%&
$CHECKING:OFF
...
GUI_Object_set_delete_proc this, GUI_ELEMENT_FRAME_DELETE_ptr%&
...
GUI_Object_set_delete_proc this, GUI_ELEMENT_WINDOW_DELETE_ptr%&
...
DECLARE CUSTOMTYPE LIBRARY "oop_ex_OUTPUT"
  ...
  FUNCTION GUI_OBJECT_RELEASE_REF_ptr%& ()
  FUNCTION GUI_OBJECT_SET_DELETE_PROC_ptr%& ()
  FUNCTION GUI_OBJECT_CLEAR_ptr%& ()
  FUNCTION GUI_OBJECT_DELETE_ptr%& ()
