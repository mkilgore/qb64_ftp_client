...
CONST GUI_OBJECT_FLAG_FLOATING = 1
...
handle_id = GUI_signal_Object_attach_proc_to_signal&(button, "pressed", TEST_SIGNAL1_ptr%&, GUI_NULL)
handle_id = GUI_signal_Object_attach_proc_to_signal&(button, "pressed", TEST_SIGNAL2_ptr%&, GUI_NULL)
handle_id = GUI_signal_Object_attach_proc_to_signal&(button, "pressed", TEST_SIGNAL3_ptr%&, GUI_NULL)
handle_id = GUI_signal_Object_attach_proc_to_signal&(button, "pressed", TEST_SIGNAL4_ptr%&, GUI_NULL)
handle_id = GUI_signal_Object_attach_proc_to_signal&(button, "pressed", TEST_SIGNAL5_ptr%&, GUI_NULL)
handle_id = GUI_signal_Object_attach_proc_to_signal&(button, "pressed", TEST_SIGNAL6_ptr%&, GUI_NULL)
handle_id = GUI_signal_Object_attach_proc_to_signal&(button, "pressed", TEST_SIGNAL7_ptr%&, GUI_NULL)
handle_id = GUI_signal_Object_attach_proc_to_signal&(button, "pressed", TEST_SIGNAL8_ptr%&, GUI_NULL)
...
$CHECKING:OFF
_MEMPUT GUI__QB64__EMPTY_MEM, THIS+ _OFFSET(GUI_SIGNAL_OBJECT.NEXT_ID, TYPE),  1 AS LONG
$CHECKING:ON
...
FUNCTION GUI_signal_Object_attach_proc_to_signal& (this as _OFFSET, n$, pro as _OFFSET, dat as _OFFSET)
$CHECKING:OFF
DIM sig as _OFFSET, con as _OFFSET, m as MEM_string
DIM new_connect AS _offset
$CHECKING:OFF
SIG = _MEMGET(GUI__QB64__EMPTY_MEM, THIS + _OFFSET(GUI_SIGNAL_OBJECT.FIRST_SIGNAL, TYPE), _OFFSET) 
$CHECKING:ON
DO while sig <> 0
$CHECKING:OFF
M = _MEMGET(GUI__QB64__EMPTY_MEM, SIG + _OFFSET(GUI_SIGNAL.SIGNAL_NAME, TYPE), MEM_STRING) 
$CHECKING:ON
...
$CHECKING:ON
$CHECKING:OFF
_MEMPUT GUI__QB64__EMPTY_MEM, NEW_CONNECT+ _OFFSET(GUI_SIGNAL_CONNECTION.ID, TYPE),  _MEMGET(GUI__QB64__EMPTY_MEM, THIS + _OFFSET(GUI_SIGNAL_OBJECT.NEXT_ID, TYPE), LONG)  AS LONG
$CHECKING:ON
$CHECKING:OFF
_MEMPUT GUI__QB64__EMPTY_MEM, NEW_CONNECT+ _OFFSET(GUI_SIGNAL_CONNECTION.DAT, TYPE),  DAT
$CHECKING:ON
$CHECKING:OFF
_MEMPUT GUI__QB64__EMPTY_MEM, NEW_CONNECT+ _OFFSET(GUI_SIGNAL_CONNECTION.NEXT_CONNECTION, TYPE),  _MEMGET(GUI__QB64__EMPTY_MEM, SIG + _OFFSET(GUI_SIGNAL.FIRST_CONNECTION, TYPE), _OFFSET)  AS _OFFSET
$CHECKING:ON
$CHECKING:OFF
_MEMPUT GUI__QB64__EMPTY_MEM, SIG+ _OFFSET(GUI_SIGNAL.FIRST_CONNECTION, TYPE),  NEW_CONNECT
$CHECKING:ON
$CHECKING:OFF
_MEMPUT GUI__QB64__EMPTY_MEM, THIS+ _OFFSET(GUI_SIGNAL_OBJECT.NEXT_ID, TYPE),  _MEMGET(GUI__QB64__EMPTY_MEM, THIS + _OFFSET(GUI_SIGNAL_OBJECT.NEXT_ID, TYPE), LONG)  + 1 AS LONG
$CHECKING:ON
$CHECKING:OFF
GUI_SIGNAL_OBJECT_ATTACH_PROC_TO_SIGNAL& = _MEMGET(GUI__QB64__EMPTY_MEM, NEW_CONNECT + _OFFSET(GUI_SIGNAL_CONNECTION.ID, TYPE), LONG) 
$CHECKING:ON
    exit function
  end if
$CHECKING:OFF
SIG = _MEMGET(GUI__QB64__EMPTY_MEM, SIG + _OFFSET(GUI_SIGNAL.NEXT_SIGNAL, TYPE), _OFFSET) 
$CHECKING:ON
loop
$CHECKING:ON
...
MEM_put_str m, n$
$CHECKING:OFF
_MEMPUT GUI__QB64__EMPTY_MEM, SIG+ _OFFSET(GUI_SIGNAL.SIGNAL_NAME, TYPE),  M
$CHECKING:ON
$CHECKING:OFF
_MEMPUT GUI__QB64__EMPTY_MEM, SIG+ _OFFSET(GUI_SIGNAL.FIRST_CONNECTION, TYPE),  0 AS LONG
$CHECKING:ON
$CHECKING:OFF
_MEMPUT GUI__QB64__EMPTY_MEM, SIG+ _OFFSET(GUI_SIGNAL.NEXT_SIGNAL, TYPE),  _MEMGET(GUI__QB64__EMPTY_MEM, THIS + _OFFSET(GUI_SIGNAL_OBJECT.FIRST_SIGNAL, TYPE), _OFFSET)  AS _OFFSET
$CHECKING:ON
$CHECKING:OFF
_MEMPUT GUI__QB64__EMPTY_MEM, THIS+ _OFFSET(GUI_SIGNAL_OBJECT.FIRST_SIGNAL, TYPE),  SIG
$CHECKING:ON
...
$CHECKING:OFF
OF = _MEMGET(GUI__QB64__EMPTY_MEM, THIS + _OFFSET(GUI_SIGNAL_OBJECT.FIRST_SIGNAL, TYPE), _OFFSET) 
$CHECKING:ON
DO while of <> 0
$CHECKING:OFF
M = _MEMGET(GUI__QB64__EMPTY_MEM, OF + _OFFSET(GUI_SIGNAL.SIGNAL_NAME, TYPE), MEM_STRING) 
$CHECKING:ON
  if MEM_get_str$(m) = n$ then
    
$CHECKING:OFF
OFF2 = _MEMGET(GUI__QB64__EMPTY_MEM, OF + _OFFSET(GUI_SIGNAL.FIRST_CONNECTION, TYPE), _OFFSET) 
$CHECKING:ON
    DO WHILE off2 <> 0
$CHECKING:OFF
...
$CHECKING:OFF
OF = _MEMGET(GUI__QB64__EMPTY_MEM, OF + _OFFSET(GUI_SIGNAL.NEXT_SIGNAL, TYPE), _OFFSET) 
$CHECKING:ON
LOOP 
$CHECKING:ON
...
END SUB
  ...
  GUI_Object_init this
$CHECKING:OFF
_MEMPUT GUI__QB64__EMPTY_MEM, THIS+ _OFFSET(GUI_ELEMENT.IMG, TYPE),  -1 AS LONG
$CHECKING:ON
...
$CHECKING:OFF
GUI_ELEMENT_GET_WIDTH& = _MEMGET(GUI__QB64__EMPTY_MEM, THIS + _OFFSET(GUI_ELEMENT.SIZE.WID, TYPE), LONG) 
$CHECKING:ON
...
$CHECKING:OFF
GUI_ELEMENT_GET_HEIGHT& = _MEMGET(GUI__QB64__EMPTY_MEM, THIS + _OFFSET(GUI_ELEMENT.SIZE.HEI, TYPE), LONG) 
$CHECKING:ON
...
$CHECKING:OFF
I& = _NEWIMAGE(_MEMGET(GUI__QB64__EMPTY_MEM, THIS + _OFFSET(GUI_ELEMENT.SIZE.HEI, TYPE), LONG) , _MEMGET(GUI__QB64__EMPTY_MEM, THIS + _OFFSET(GUI_ELEMENT.SIZE.WID, TYPE), LONG) , 0)
$CHECKING:ON
$CHECKING:OFF
...
$CHECKING:OFF
_MEMPUT GUI__QB64__EMPTY_MEM, THIS+ _OFFSET(GUI_ELEMENT.SIZE.WID, TYPE),  WID
$CHECKING:ON
$CHECKING:OFF
_MEMPUT GUI__QB64__EMPTY_MEM, THIS+ _OFFSET(GUI_ELEMENT.SIZE.HEI, TYPE),  HEI
$CHECKING:ON
...
$CHECKING:OFF
_MEMPUT GUI__QB64__EMPTY_MEM, THIS+ _OFFSET(GUI_ELEMENT.SIZE, TYPE),  D
$CHECKING:ON
  GUI_element_create_image this
...
$CHECKING:OFF
_MEMPUT GUI__QB64__EMPTY_MEM, THIS+ _OFFSET(GUI_ELEMENT.SIZE.ROW, TYPE),  ROW
$CHECKING:ON
$CHECKING:OFF
_MEMPUT GUI__QB64__EMPTY_MEM, THIS+ _OFFSET(GUI_ELEMENT.SIZE.COL, TYPE),  COL
$CHECKING:ON
...
$CHECKING:OFF
GUI_ELEMENT_GET_ROW& = _MEMGET(GUI__QB64__EMPTY_MEM, THIS + _OFFSET(GUI_ELEMENT.SIZE.ROW, TYPE), LONG) 
$CHECKING:ON
...
$CHECKING:OFF
GUI_ELEMENT_GET_COL& = _MEMGET(GUI__QB64__EMPTY_MEM, THIS + _OFFSET(GUI_ELEMENT.SIZE.COL, TYPE), LONG) 
$CHECKING:ON
...
DECLARE CUSTOMTYPE LIBRARY "oop_ex_OUTPUT"
  ...
  FUNCTION TEST_SIGNAL4_ptr%& ()
  FUNCTION TEST_SIGNAL5_ptr%& ()
  FUNCTION TEST_SIGNAL6_ptr%& ()
  FUNCTION TEST_SIGNAL7_ptr%& ()
  FUNCTION TEST_SIGNAL8_ptr%& ()
  ...
  FUNCTION GUI_SIGNAL_OBJECT_INIT_ptr%& ()
  FUNCTION GUI_SIGNAL_OBJECT_CLEAR_ptr%& ()
  FUNCTION GUI_SIGNAL_OBJECT_CLEAR_SIGNALS_ptr%& ()
  FUNCTION GUI_SIGNAL_OBJECT_DISCONNECT_SIGNAL_ptr%& ()
  FUNCTION GUI_SIGNAL_OBJECT_ADD_NEW_SIGNAL_ptr%& ()
  FUNCTION GUI_SIGNAL_OBJECT_EMIT_SIGNAL_ptr%& ()
  FUNCTION GUI_OBJECT_INIT_ptr%& ()
  FUNCTION GUI_OBJECT_CLEAR_ptr%& ()
