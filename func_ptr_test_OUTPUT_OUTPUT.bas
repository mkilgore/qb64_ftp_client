...
$CHECKING:OFF
CALL__OFFSET  _MEMGET(GUI__QB64__EMPTY_MEM, O + _OFFSET(GUI_OBJECT.F, TYPE), _OFFSET) , O
$CHECKING:ON
...
$CHECKING:OFF
_MEMPUT GUI__QB64__EMPTY_MEM, O+ _OFFSET(GUI_OBJECT.F, TYPE),  F
$CHECKING:ON
...
DECLARE CUSTOMTYPE LIBRARY "func_ptr_test_OUTPUT"
  ...
  SUB call__OFFSET( va AS _OFFSET, A AS _OFFSET)
  SUB call__OFFSET__OFFSET_LONG( va AS _OFFSET, A AS _OFFSET, B AS _OFFSET, C AS LONG)
  SUB call__OFFSET_LONG_LONG( va AS _OFFSET, A AS _OFFSET, B AS LONG, C AS LONG)
  SUB call__OFFSET__OFFSET( va AS _OFFSET, A AS _OFFSET, B AS _OFFSET)
  SUB call_MEM_STRING_STRING( va AS _OFFSET, A AS MEM_STRING, B AS STRING)
  SUB call_MEM_ARRAY_SINGLE_STRING( va AS _OFFSET, A AS MEM_ARRAY, B AS SINGLE, C AS STRING)
  SUB call_MEM_ARRAY_SINGLE_SINGLE( va AS _OFFSET, A AS MEM_ARRAY, B AS SINGLE, C AS SINGLE)
  SUB call_MEM_ARRAY_SINGLE( va AS _OFFSET, A AS MEM_ARRAY, B AS SINGLE)
  SUB call_MEM_ARRAY( va AS _OFFSET, A AS MEM_ARRAY)
  SUB call_MEM_STRING( va AS _OFFSET, A AS MEM_STRING)
END DECLARE
DECLARE CUSTOMTYPE LIBRARY "func_ptr_test_OUTPUT_OUTPUT"
  FUNCTION MEM_FREE_ptr%& ()
  FUNCTION MEM_MEMCPY_ptr%& ()
  FUNCTION MEM_MEMSET_ptr%& ()
  FUNCTION MEM_MEMMOVE_ptr%& ()
  ...
  FUNCTION MEM_FREE_ARRAY_ptr%& ()
  FUNCTION MEM_FREE_STRING_ptr%& ()
  FUNCTION CALL__OFFSET(_ptr%& ()
  FUNCTION CALL__OFFSET__OFFSET_LONG(_ptr%& ()
  FUNCTION CALL__OFFSET_LONG_LONG(_ptr%& ()
  FUNCTION CALL__OFFSET__OFFSET(_ptr%& ()
  FUNCTION CALL_MEM_STRING_STRING(_ptr%& ()
  FUNCTION CALL_MEM_ARRAY_SINGLE_STRING(_ptr%& ()
  FUNCTION CALL_MEM_ARRAY_SINGLE_SINGLE(_ptr%& ()
  FUNCTION CALL_MEM_ARRAY_SINGLE(_ptr%& ()
  FUNCTION CALL_MEM_ARRAY(_ptr%& ()
  FUNCTION CALL_MEM_STRING(_ptr%& ()
  SUB call__OFFSET( va AS _OFFSET, A AS _OFFSET)
  SUB call__OFFSET__OFFSET_LONG( va AS _OFFSET, A AS _OFFSET, B AS _OFFSET, C AS LONG)
  SUB call__OFFSET_LONG_LONG( va AS _OFFSET, A AS _OFFSET, B AS LONG, C AS LONG)
  SUB call__OFFSET__OFFSET( va AS _OFFSET, A AS _OFFSET, B AS _OFFSET)
  ...
  SUB call_MEM_ARRAY( va AS _OFFSET, A AS MEM_ARRAY)
  SUB call_MEM_STRING( va AS _OFFSET, A AS MEM_STRING)
  SUB call__OFFSET__OFFSET__OFFSET_LONG( va AS _OFFSET, A AS _OFFSET, B AS _OFFSET, C AS _OFFSET, D AS LONG)
  SUB call__OFFSET__OFFSET_LONG_LONG( va AS _OFFSET, A AS _OFFSET, B AS _OFFSET, C AS LONG, D AS LONG)
  SUB call__OFFSET__OFFSET__OFFSET( va AS _OFFSET, A AS _OFFSET, B AS _OFFSET, C AS _OFFSET)
  SUB call__OFFSET_MEM_STRING_STRING( va AS _OFFSET, A AS _OFFSET, B AS MEM_STRING, C AS STRING)
  SUB call__OFFSET_MEM_ARRAY_SINGLE_STRING( va AS _OFFSET, A AS _OFFSET, B AS MEM_ARRAY, C AS SINGLE, D AS STRING)
  SUB call__OFFSET_MEM_ARRAY_SINGLE_SINGLE( va AS _OFFSET, A AS _OFFSET, B AS MEM_ARRAY, C AS SINGLE, D AS SINGLE)
  SUB call__OFFSET_MEM_ARRAY_SINGLE( va AS _OFFSET, A AS _OFFSET, B AS MEM_ARRAY, C AS SINGLE)
  SUB call__OFFSET_MEM_ARRAY( va AS _OFFSET, A AS _OFFSET, B AS MEM_ARRAY)
  SUB call__OFFSET_MEM_STRING( va AS _OFFSET, A AS _OFFSET, B AS MEM_STRING)
END DECLARE
